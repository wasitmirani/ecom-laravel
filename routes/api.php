...
Route::get('/frontend/products',[ApiProductController::class,'products']);

// Mobile App Api's
Route::name('app.')->prefix('app')->group(function () {
Route::get('/categories',[ApiCategoryController::class,'index']);
Route::get('/products',[ApiProductController::class,'getProducts']);
Route::get('/my/cart',[ApiCartController::class,'myCart']);
Route::get('/add/cart',[ApiCartController::class,'addToCart']);
Route::get('/remove/cart/{id}',[ApiCartController::class,'removeCart']);
Route::get('/find/products',[ApiProductController::class,'findProducts']);
Route::post('order/procced',[ApiOrderController::class,'proccedOrder']);
