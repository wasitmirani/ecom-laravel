          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-sm-6 col-12 mb-2 mb-sm-0">
              <div class="media">
                ...
                <div class="media-body my-auto">
                  <h4 class="font-weight-bolder mb-0">
                   {{this.$currency}}{{ this.totaldiscount }}
                  </h4>
            ...
            <div class="col-xl-4 col-sm-6 col-12">
              <div class="media">
                ...
                <div class="media-body my-auto">
                  <h4 class="font-weight-bolder mb-0">
                    {{this.$currency}}{{ this.totalRevenue }}
                  </h4>
          ...
          <b-overlay :show="isLoading" variants="transparent" rounded="md">
            ...
            <h4 class="card-text font-small-2 mr-25 mb-0">
              ...
              <strong class="ml-1 text-danger">{{ enddate }}</strong>
                    ...
                    <h2 class="font-weight-bolder mb-1 mt-2">{{$currency}}{{ totalSale }}</h2>
                    <div id="chart"></div>
                  </div>
                </div>
              </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <h5 class="mb-1 mt-2">{{$currency}}{{totalRevenue}}</h5>
