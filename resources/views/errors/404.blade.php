...
@section('content')
          ...
          <section class="not-found-page section-padding">
            ...
            <h1><img class="img-fluid" src="{{asset('/frontend/img/404.png')}}" alt="404"></h1>
            <h1>Sorry! Page not found.</h1>
            <p class="land">Unfortunately the page you are looking for has been moved or deleted.</p>
            <div class="mt-5">
            <a href="{{ url()->previous()}}" class="btn btn-success btn-lg"><i class="mdi mdi-home"></i> GO TO HOME PAGE</a>
            </div>
            </div>
            </div>
            </div>
